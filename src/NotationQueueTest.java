...
public class NotationQueueTest {
	...
	public double d1=1.0, d2=12.0, d3=13.0, d4=24.0;
	ArrayList<Double> fill2 = new ArrayList<Double>();
	...
	public void testDequeueStudent() {
		...
		try {
		assertEquals((Double)d1, doubleQ.dequeue());
		assertEquals((Double)d2, doubleQ.dequeue());
		assertEquals((Double)d3, doubleQ.dequeue());
		//Queue is empty, next statement should cause QueueUnderFlowException
		doubleQ.dequeue();
		assertTrue("This should have caused an QueueUnderflowException", false);
	}
	...
	public void testToStringStudent() throws QueueOverflowException {
		//Use the doubleQ for student tests
		assertEquals("1.012.013.0", doubleQ.toString());
		doubleQ.enqueue(44.0);
		assertEquals("1.012.013.044.0", doubleQ.toString());
		doubleQ.enqueue(55.5);
		assertEquals("1.012.013.044.055.5", doubleQ.toString());
	}
